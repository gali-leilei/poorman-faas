...
async def smart_request(url: str, params: dict[str, Any] | None = None) -> str:
...
async def _google_search_internal(
    ...
    try:
        ...
        return decode_percent_encoded_urls(result_content, input_type="text")
    except Exception as e:
        return f"[ERROR]: google_search tool execution failed: {str(e)}"
